...
import { Breadcrumb, BreadcrumbItem, Row, Label, Button, Col} from 'reactstrap';
...
class Contact extends Component {
    ...
    handleSubmit(values){
        ...
        this.props.postFeedback(values.firstname, values.lastname, values.telnum, values.email, values.agree, values.message, values.contactType)
